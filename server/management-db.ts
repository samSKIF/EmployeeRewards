...
const MANAGEMENT_DB_URL = process.env.MANAGEMENT_DATABASE_URL || process.env.DATABASE_URL;
...
export const managementDb = drizzle({ client: managementPool, schema: managementSchema });