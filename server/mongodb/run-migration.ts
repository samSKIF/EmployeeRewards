...
async function executeMigration() {
  try {
    ...
    if (!db) {
      console.log('❌ MongoDB not available. Please provide MONGODB_URI environment variable.');
      return;
    }
    ...
    console.log('📊 Social posts, comments, and reactions have been migrated to MongoDB');
