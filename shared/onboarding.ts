...
export const onboardingPlansRelations = relations(
  onboardingPlans,
  ({ many }) => ({
...
export const onboardingMissionsRelations = relations(
  onboardingMissions,
  ({ one, many }) => ({
...
export const onboardingAssignmentsRelations = relations(
...
export const insertOnboardingMissionSchema = createInsertSchema(
  onboardingMissions
).omit({ id: true, createdAt: true, updatedAt: true });

export const insertOnboardingAssignmentSchema = createInsertSchema(
  onboardingAssignments
).omit({ id: true, createdAt: true, updatedAt: true });
...
export type InsertOnboardingMission = z.infer<
  typeof insertOnboardingMissionSchema
>;

export type OnboardingAssignment = typeof onboardingAssignments.$inferSelect;
export type InsertOnboardingAssignment = z.infer<
  typeof insertOnboardingAssignmentSchema
>;
