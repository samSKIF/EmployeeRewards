...
const getCoverImage = (channelType: string) => {
  const covers = {
    'department': 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=1200&h=300&fit=crop',
    'site': 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&h=300&fit=crop',
    'interest': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&h=300&fit=crop',
    'project': 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=300&fit=crop',
    'social': 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1200&h=300&fit=crop',
    'company-wide': 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&h=300&fit=crop'
  };
          ...
          <div className="flex items-center justify-between py-4">
            <Tabs defaultValue="discussion" className="flex-1">
              <TabsList className="bg-transparent border-none">
                <TabsTrigger value="discussion" className="text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600">
                  Discussion
                </TabsTrigger>
              ...
              {postsLoading ? (
                ...
                <Card>
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600">Be the first to share something with this channel!</p>
                  </CardContent>
                </Card>
              )}
            </div>
