    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2 flex flex-col items-center">
          ...
          <CardTitle className="text-2xl font-bold text-center">ThrivioHR Corporate</CardTitle>
          <p className="text-center text-gray-600">Corporate Admin Access</p>
        </CardHeader>
        
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <h3 className="font-semibold text-blue-800 mb-2">Step 1: Create Corporate Admin</h3>
            <p className="text-sm text-blue-700 mb-3">First, create the corporate admin account</p>
            <Button 
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              <div>
                <Label htmlFor="email" className="text-sm text-green-700">Email</Label>
                <Input
                  id="email"
                  type="email"
                  value={loginEmail}
              ...
              <div>
                <Label htmlFor="password" className="text-sm text-green-700">Password</Label>
                <Input
                  id="password"
                  type="password"
                  value={loginPassword}
