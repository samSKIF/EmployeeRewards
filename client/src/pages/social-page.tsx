            ...
            {post.recognition.recipientId && (
              <div className="mt-3 flex">
                <div className="flex-1">
                  <div className="text-xs text-amber-700 uppercase font-medium">
                    Recipient
                  </div>
                  <div className="font-medium">
                    {users.find((u) => u.id === post.recognition?.recipientId)
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 pt-4 max-w-[2200px] mx-auto justify-center">
        ...
        <div
          className="hidden lg:block lg:col-span-3 w-full"
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
            <div className="p-4">
              ...
              <div className="mt-4 text-sm text-gray-500 flex items-center justify-between">
                <div>
                  You've recognized{' '}
                  <span className="font-semibold text-teal-600">80%</span> of
