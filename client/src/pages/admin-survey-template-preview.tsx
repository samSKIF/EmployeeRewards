          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg border text-center">
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 mb-8 max-w-md">
                You've completed the preview of this template. Would you like to use it to create a new survey?
              </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-1 text-sm text-amber-700">
                    This is a preview of how the survey will look. No responses will be saved.
                  </div>
                </div>
              </div>
            </div>
