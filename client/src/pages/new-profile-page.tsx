...
import { 
  ...
  Zap, Heart, Camera as CameraIcon, Search, Settings, 
  BarChart4, Share2
} from "lucide-react";
      ...
      <div className="grid grid-cols-12 gap-6 p-6 bg-gray-50">
        ...
        <div className="col-span-3">
          ...
          <Card className="mb-6 overflow-hidden">
            <div className="relative h-60 bg-orange-100 p-6 flex flex-col justify-center items-center">
              <Button variant="outline" size="sm" className="absolute right-4 top-4 bg-white" onClick={handleEditToggle}>
            ...
            <div className="p-4">
              <div className="mb-4">
                <div className="text-sm text-gray-500 mb-1">Profile Status {userDetails.profileStatus}%</div>
        ...
        <div className="col-span-9 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div>
                <h3 className="text-lg font-semibold mb-2">{personalityType.title}</h3>
              ...
              <div className="mt-6">
                <h4 className="font-medium text-gray-700 mb-3">People most like {user?.name?.split(' ')[0] || "you"}</h4>
                <div className="flex space-x-3">
                  {similarPeople.map(person => (
                    <Avatar key={person.id} className="h-10 w-10 border border-gray-200">
            ...
            <CardContent>
              <div className="grid grid-cols-4 gap-4">
                {interests.map(interest => (
                  <div key={interest.id} className="flex items-center gap-2 border rounded-md p-3">
            ...
            <CardContent>
              <div className="grid grid-cols-4 gap-4">
                {strengths.map(strength => (
                  <div key={strength.id} className="flex items-center gap-2 border rounded-md p-3">
                    <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
