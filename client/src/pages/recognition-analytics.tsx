...
const departmentData = [
  { department: 'Engineering', recognitions: 89, points: 1780, participation: 92 },
...
const topRecognizers = [
  { name: 'Sarah Johnson', department: 'Engineering', given: 15, received: 8, points: 320 },
  { name: 'Michael Chen', department: 'Sales', given: 12, received: 11, points: 290 },
  { name: 'Emma Davis', department: 'Marketing', given: 10, received: 9, points: 265 },
  { name: 'David Wilson', department: 'Engineering', given: 9, received: 12, points: 245 },
...
export default function RecognitionAnalytics({ isAdmin = false, userId, teamId }: RecognitionAnalyticsProps) {
  ...
  const { data: analytics } = useQuery({
    queryKey: ['/api/recognition/analytics', { dateRange, department: selectedDepartment, userId, teamId }],
  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Recognition Analytics</h1>
          <p className="text-muted-foreground">
            {isAdmin ? "Organization-wide recognition insights" : "Your team's recognition performance"}
          </p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={recognitionTrends}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Area type="monotone" dataKey="recognitions" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card className="col-span-1">
              <CardHeader>
                ...
                <CardDescription>Distribution by recognition type</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <RechartsPieChart>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest recognitions across the organization</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  { giver: "Sarah Johnson", receiver: "Mike Chen", category: "Teamwork", points: 50, time: "2 hours ago" },
                  { giver: "Emma Davis", receiver: "Lisa Brown", category: "Innovation", points: 75, time: "4 hours ago" },
                  { giver: "David Wilson", receiver: "Sarah Johnson", category: "Leadership", points: 100, time: "6 hours ago" }
                ].map((activity, index) => (
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="font-medium">
                          <span className="text-blue-600">{activity.giver}</span> recognized{" "}
                          <span className="text-green-600">{activity.receiver}</span>
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Category: {activity.category} • {activity.points} points
                        </p>
                      </div>
                    </div>
        ...
        <TabsContent value="trends" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track recognition patterns over time</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={recognitionTrends}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line yAxisId="left" type="monotone" dataKey="recognitions" stroke="#8884d8" strokeWidth={2} />
                  <Line yAxisId="right" type="monotone" dataKey="points" stroke="#82ca9d" strokeWidth={2} />
                  <Line yAxisId="left" type="monotone" dataKey="employees" stroke="#ffc658" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
        ...
        <TabsContent value="departments" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Recognition metrics by department</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Employees giving the most recognition</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {topRecognizers.map((user, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">{user.points} pts</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Employees receiving the most recognition</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {topRecognizers.map((user, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <Badge variant="outline">{user.received} received</Badge>
                        <p className="text-xs text-muted-foreground mt-1">{user.points} pts</p>
                      </div>
                    </div>
                  ))}
          ...
          <div className="grid gap-6 md:grid-cols-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Finance team has 29% lower recognition activity. Consider a team-building initiative.
                    </p>
                  </div>
                  <div className="border-l-4 border-green-500 pl-4">
                    <h4 className="font-medium">Positive Trend</h4>
                    <p className="text-sm text-muted-foreground">
                      Cross-department recognitions increased 35% this month - great collaboration!
                    </p>
                  </div>
                  <div className="border-l-4 border-yellow-500 pl-4">
                    <h4 className="font-medium">Recognition Gap</h4>
                    <p className="text-sm text-muted-foreground">
                      12 employees haven't received recognition in 45 days. Send nudges to managers.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Recognition message sentiment trends</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
