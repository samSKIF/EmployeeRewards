...
const SocialLayout: React.FC<SocialLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[235px_auto_235px] gap-6 min-h-screen bg-gray-100"> {/* Modified to use grid layout */}
      {/* Top Navigation */}
      ...
      {/* Main content */}
      <div className="lg:col-span-2"> {/* Adjusts main content to span multiple columns on larger screens */}
        ...
        {/* Page content */}
        <main className="py-6">
          <div className="px-4"> {/* Removed max-width restriction */}
            {children}
          </div>
        </main>
      </div>
