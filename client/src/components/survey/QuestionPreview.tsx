...
export default function QuestionPreview({ question, readOnly = true }: QuestionPreviewProps) {
        ...
        return (
          <div>
            ...
            <input 
              ...
              max="100" 
              value={sliderValue}
              onChange={(e) => !readOnly && setSliderValue(parseInt(e.target.value))}
              className="w-full"
              disabled={readOnly}
            />
      ...
      case "semantic":
        return (
          <div className="space-y-3">
            {[["Confusing", "Clear"], ["Slow", "Fast"], ["Unattractive", "Attractive"]].map(([left, right], index) => (
        ...
        return (
          <div className="border bg-gray-100 w-full h-28 rounded relative cursor-pointer">
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-xs text-gray-500">Click anywhere on this image</span>
            </div>
